...
import {
  ...
  resolveFirstAnnotationLabelColor,
...
export function createMarkOddEvenSession(
  ...
  const labelColor =
    resolveFirstAnnotationLabelColor(document, "单双") ??
    resolveBusinessCommandLabelColor(document, "单双");
    ...
    domain: {
      ...
      标注样式: {
        ...
        单双: {
          ...base.domain.标注样式.单双,
          字体:
            base.domain.标注样式.单双?.字体 ??
            "system-ui, -apple-system, Segoe UI, Roboto, sans-serif",
          字号: session.labelFontSize,
          字色: session.labelColor,
        },
      },
    },
  };
