...
export enum 假发类型 {
  ...
  纯色 = "纯色",
  上下分 = "上下分",
  /* 单T色一定有DL，如果裁断项是多行，则DL重量按照规则：
  - 一个裁断项：D,L有重量
  - 两个裁断项：第一个裁断项D有重量，第二个裁断项M有重量
  - 三个裁断项：第一个裁断项D有重量，第二个裁断项M有重量，第三个裁断项D有重量（开始轮询）
   */
  单T色 = "单T色",
}
